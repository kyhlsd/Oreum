...
public struct MountainInfo: Hashable {
    ...
    public init(id: String, name: String, address: String, height: Int, admin: String, adminNumber: String, detail: String, image: String?, referenceDate: Date, designationCriteria: String?) {
        self.id = id
        self.name = name

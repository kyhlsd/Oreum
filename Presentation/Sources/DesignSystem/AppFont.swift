...
enum AppFont {
    ...
    static var titleM: UIFont  { UIFont.systemFont(ofSize: 16, weight: .medium) } // h3
    static var titleS: UIFont  { UIFont.systemFont(ofSize: 14, weight: .medium) } // h4

    // MARK: - Body / Text
    static var body: UIFont    { UIFont.systemFont(ofSize: 14, weight: .regular) } // p
